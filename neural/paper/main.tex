...
($\approx 0.96\pm0.03$), though it is seed-sensitive on the small author pool.
...
\paragraph{A supervised head gives the best separation, with a caveat.}
Adding the prior study's leave-one-author-out supervised-contrastive head over the
encoder vectors gives the strongest separation: CANINE $+$ head $0.961\pm0.030$ at
floor $1000$, Hebrew $+$ head $0.946\pm0.040$. Two cautions attach to these
numbers. The head trains on an $11$-author cohort and is nondeterministic across
